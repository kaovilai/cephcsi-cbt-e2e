...
help:
	...
	@echo "    test-coverage      Generate test coverage report (coverage.html)"
...
clean:
	rm -f e2e.test coverage.out coverage.html
...
test-coverage:
	...
	@echo "Open with: open coverage.html  # macOS"
	@echo "       or: xdg-open coverage.html  # Linux"
